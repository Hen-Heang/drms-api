...
(
    ...
    category_id INTEGER NOT NULL REFERENCES tb_category
(
    id
)
  ON DELETE CASCADE
...
(
  ...
  ON DELETE CASCADE,
    ...
    image TEXT,
    category_id INTEGER REFERENCES tb_category
(
    id
),
    description TEXT,
...
(
    ...
    product_import_id INTEGER NOT NULL REFERENCES tb_product_import
(
    id
)
  ON DELETE CASCADE,
...
(
    ...
    store_id INTEGER NOT NULL REFERENCES tb_store
(
    id
)
  ON DELETE CASCADE,
    status_id INTEGER NOT NULL REFERENCES tb_status
(
    id
),
    created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
(
    ...
    store_product_id INTEGER NOT NULL REFERENCES tb_store_product_detail
(
    id
)
    );
...
(
    ...
    retailer_id INTEGER NOT NULL REFERENCES tb_retailer_account
(
    id
)
  ON DELETE CASCADE,
    rated_star INTEGER CHECK
(
    rated_star
    BETWEEN
    1
...
(
    ...
    retailer_account_id INTEGER NOT NULL REFERENCES tb_retailer_account
(
    id
)
  ON DELETE CASCADE,
...
(
    ...
    type_id INTEGER NOT NULL REFERENCES tb_notification_type
(
    id
),
    content TEXT,
...
VALUES (1, 'DISTRIBUTOR') ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_role (id, name)
VALUES (2, 'RETAILER') ON CONFLICT (id) DO NOTHING;
...
VALUES (1, 'PENDING'),
       ...
       (7, 'CANCELLED'),
       (8, 'REJECTED'),
       (9, 'DRAFT') ON CONFLICT (id) DO NOTHING;